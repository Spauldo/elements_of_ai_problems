...
(defpackage :net.spauldo.ai-text.chap-02
  (:use :cl :asdf))

(in-package :net.spauldo.ai-text.chap-02)
...
(defsystem ai-text.chap-02
  ...
  :long-description "Problems from Chapter 2 of Elements of Artificial Intelligence"
